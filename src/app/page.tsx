...
const BUNDLED_APPS: AppItem[] = [
  ...
  { id: 'github-ExchangeMGA', name: 'ExchangeMGA', url: 'https://thieuquillabru.github.io/ExchangeMGA/', description: 'Convertisseur Yuan -> Ariary (MGA) avec cours en temps reel', category: 'GitHub Pages', color: GITHUB_PAGES_COLOR, icon: 'BarChart3', order: 2, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), source: 'github', repoName: 'ExchangeMGA' },
  { id: 'github-EnergyX', name: 'EnergyX', url: 'https://thieuquillabru.github.io/EnergyX/', description: 'Developpement personnel : habitudes, objectifs, journal, meditation', category: 'GitHub Pages', color: GITHUB_PAGES_COLOR, icon: 'Zap', order: 3, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), source: 'github', repoName: 'EnergyX' },
  { id: 'github-akiba', name: 'akiba', url: 'https://thieuquillabru.github.io/akiba/', description: "Gestion d'argent, tontine et education financiere. PWA en 8 langues et 166 devises.", category: 'GitHub Pages', color: GITHUB_PAGES_COLOR, icon: 'BookOpen', order: 4, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), source: 'github', repoName: 'akiba' },
  { id: 'vercel-prj_sYrYBUNllneM4DQr3dOszFeLfxxy', name: 'agent-reach-web', url: 'https://agent-reach-web-zeta.vercel.app', description: 'Agent Reach - Recherche multi-plateforme (YouTube, GitHub, RSS, V2EX...)', category: 'Vercel', color: VERCEL_COLOR, icon: 'Globe', order: 5, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), source: 'vercel', repoName: 'agent-reach-web' },
]
